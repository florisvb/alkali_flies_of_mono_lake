import pandas
import read_raw_data_to_pandas
import numpy as np
import sys
sys.path.append('/media/Orchard3/monolake_2016/september')
...
hairiness_filename = '/home/caveman/Documents/Projects/Alkali_Fly/SEM/20161118/species_hairiness.pickle'
...
dip_data_paths = {  'blackkelp': '/media/Orchard3/monolake_2016/september/blackkelp_2016_diwater_monowater_carb',
                    'melanogaster': '/media/Orchard3/monolake_2016/september/melanogaster_2016_diwater_monowater_carb',
                    'ephydra': '/media/Orchard3/monolake_2016/september/ephydra_2016_diwater_monowater_carb',
                    'virilis': '/media/Orchard3/monolake_2016/september/virilis_2016_diwater_monowater_carb',
                    'bluekelp': '/media/Orchard3/monolake_2016/september/bluekelp_2016_diwater_monowater_carb',
                    'oilfly': '/media/Orchard3/monolake_2016/september/oilflies_2016_diwater_monowater_carb',
                    'santaana': '/media/Orchard3/monolake_2016/september/santa_ana_2016_diwater_monowater_carb',
                    }

GCMS_path = '/home/caveman/Documents/Projects/Alkali_Fly/GCMS/2016/rawdata'
...
def make_solution_size_summary_figure():
    ...
    compile_stats_to_pandas.plot_correlation_with_size_removed(pd, 'carb', ['hairyness', 'RetTimeAvg', 'pulvilli'])
...
def plot_correlation_with_size_removed(pd, output, inputs, ax=None):
    ...
    if write_svg:
        ...
        layout.write_svg('/media/Orchard3/monolake_2016/september/figure3.svg')
    
    return formula_results

def get_paper_layout():
    svg = '/media/Orchard3/monolake_2016/september/figure3.svg'
    layout = figurefirst.svg_to_axes.FigureLayout(svg)
    layout.make_mplfigures()
    return layout

def write_figure_to_svg(layout, figure_name):
...
def compile_data_for_species(species, return_mean=True):
    ...
    if return_mean:
        ...
        gcms_data = read_raw_data_to_pandas.parse_rows(GCMS_path, species, start=17)
...
def get_pd_tmp(pd, remove_species=[]):
    ...
    for key in pd_tmp.keys():     
        if key == 'species' or key == 'water_type':
            continue
        else:
...
def make_correlation_matrix_figure(pd):
    ...
    write_figure_to_svg(layout, 'correlation_matrix')
